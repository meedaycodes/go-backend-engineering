...
import (
	...
	"github.com/meedaycodes/day13-sdlc-tooling/internal/validator"
)
...
func (a *AuthHandler) Signup(w http.ResponseWriter, r *http.Request) {
	...
	if errors.As(err, &vldError) {
		...
		err = json.NewEncoder(w).Encode(vldError.Fields)
		if err != nil {
			http.Error(w, "Request body in bad format", http.StatusBadRequest)
			return
		}
		return
	}
